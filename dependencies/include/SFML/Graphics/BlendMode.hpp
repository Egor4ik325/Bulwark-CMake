...
/// mode determines how the colors of an object you onDraw are
...
/// \endcode
///
/// In SFML, a blend mode can be specified every time you onDraw a sf::Drawable
/// object to a render target. It is part of the sf::RenderStates compound
/// that is passed to the member function sf::RenderTarget::onDraw().
///
