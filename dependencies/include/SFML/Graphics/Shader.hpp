...
public:
    ...
    /// ...
    /// sf::Shader::bind(&s1);
    /// // onDraw OpenGL stuff that use s1...
    /// sf::Shader::bind(&s2);
    /// // onDraw OpenGL stuff that use s2...
    /// sf::Shader::bind(NULL);
    /// // onDraw OpenGL stuff that use no shader...
    /// \endcode
    ///
...
/// additional parameter to the \ref RenderWindow::onDraw function:
/// \code
/// window.onDraw(sprite, &shader);
/// \endcode
///
...
/// \li onDraw everything to a sf::RenderTexture, then onDraw it to
///     the main target using the shader
/// \li onDraw everything directly to the main target, then use
///     sf::Texture::onUpdate(Window&) to copy its contents to a texture
///     and onDraw it to the main target using the shader
///
