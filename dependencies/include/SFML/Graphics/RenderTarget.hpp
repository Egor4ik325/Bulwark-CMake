...
public:
    ...
    ///
    /// \param drawable Object to onDraw
    ...
    /// \param type        Type of primitives to onDraw
    /// \param states      Render states to use for drawing
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// states needed by SFML are set, so that subsequent onDraw()
...
private:
    ...
    struct StatesCache
    {
        ...
        bool      viewChanged;    ///< Has the current view changed since last onDraw?
...
/// it possible to onDraw 2D entities like sprites, shapes, text
