...
public:
    ...
    ///
    /// \return True if the onUpdate was successful
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// than the size of the currently created buffer, the onUpdate fails.
    ///
    /// No additional check is performed on the size of the vertex
    /// array, passing invalid arguments will lead to undefined
    /// behavior.
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the type of primitives to onDraw
    ///
    /// This function defines how the vertices must be interpreted
    /// when it's time to onDraw them.
    ///
    ...
    /// going to be used in terms of data onUpdate frequency.
    ///
    ...
    /// // onDraw OpenGL stuff that use vb1...
    /// sf::VertexBuffer::bind(&vb2);
    /// // onDraw OpenGL stuff that use vb2...
    /// sf::VertexBuffer::bind(NULL);
    /// // onDraw OpenGL stuff that use no vertex buffer...
    /// \endcode
    ///
...
private:
    ...
    ///
    /// \param target Render target to onDraw to
...
private:
    ...
    PrimitiveType m_primitiveType; ///< Type of primitives to onDraw
...
///
/// In special cases, the user can make use of multiple threads to onUpdate
...
/// triangles.create(15);
/// triangles.onUpdate(vertices);
/// ...
/// window.onDraw(triangles);
/// \endcode
///
