...
public:
    ...
    ///
    /// No additional check is performed on the size of the pixel
    /// array or the bounds of the area to onUpdate, passing invalid
    ...
    /// ...
    /// sf::Texture::bind(&t1);
    /// // onDraw OpenGL stuff that use t1...
    /// sf::Texture::bind(&t2);
    /// // onDraw OpenGL stuff that use t2...
    /// sf::Texture::bind(NULL);
    /// // onDraw OpenGL stuff that use no texture...
    /// \endcode
    ///
...
/// therefore it is very fast to onDraw a texture to a render target,
...
/// to the texture in a single operation (see Texture::onUpdate).
///
...
///     ...
///
///     // onUpdate the texture
///     sf::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
///     texture.onUpdate(pixels);
///
///     // onDraw it
///     window.onDraw(sprite);
///
