...
public:
    ...
    /// Be aware that any onDraw operation may modify the base level image data.
    ...
    /// want to onDraw OpenGL geometry to another render target
    ...
    /// and onDraw it using a sprite (for example).
...
private:
    ...
    Texture                  m_texture; ///< Target texture to onDraw on
};
...
///    texture.onDraw(sprite);  // sprite is a sf::Sprite
///    texture.onDraw(shape);   // shape is a sf::Shape
///    texture.onDraw(text);    // text is a sf::Text
///
